...
class StoryPage3A:
    ...
    def run(self):
        ...
        while running:
            ...
            self.draw_text_center("มังกรน้อยเชื่อใจคุณ", 100, self.font_text)
            story_text = (
            ...
            'ไปที่รังบนภูเขาเธอให้หน้ากระดาษที่มีคำศัพท์ภาษามังกรเขียนว่า Orn Darastrix \n'
            'แก่คุณก่อนจะแยกตัวกลับไปเมื่อมันกินอิ่มมันก็พูดออกมาได้คำเดียวว่า\n'
            '"Nytha" และเดินตามคุณต้อยๆ มันเข้ามาคลอเคลียที่ขาของคุณ\n'
            f'{self.character.name}กับมังกรน้อย มุ่งหน้าขึ้นไปบนภูเขาตามเส้นทาง\n'
            )
