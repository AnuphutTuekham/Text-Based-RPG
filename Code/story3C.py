...
class StoryPage3C:
    ...
    def run(self):
        ...
        while running:
            ...
            self.draw_text_center("มังกรน้อยระแวงคุณ", 100, self.font_text)
            story_text = (
            ...
            'เธอให้หน้ากระดาษที่มีคำศัพท์ภาษามังกรเขียนว่า Orn Darastrix แก่คุณ\n'
            'ก่อนจะแยกตัวกลับไปมังกรน้อยร้องว่า"Nytha"ก่อนจะเดินตามคุณอยู่ห่างๆ\n'
            f'{self.character.name} กับมังกรน้อยมุ่งหน้าขึ้นไปบนภูเขาตามเส้นทาง\n'
